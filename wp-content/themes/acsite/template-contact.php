					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						...
						<ul class="list-unstyled">
							<li class="form-list-item">
								<img class="icon" src="<?php bloginfo('template_directory'); ?>/images/dev/map_marker.png"><span id="officeAddress">400 Montgomery Street, Suite 305<br>San Francisco, CA 94104</span>
							</li>
						
							<li class="form-list-item">
								<img class="icon" src="<?php bloginfo('template_directory'); ?>/images/dev/phone1.png">
							...
							<li class="form-list-item">
								<img class="icon" id="office-fax-image" src="<?php bloginfo('template_directory'); ?>/images/dev/print.png"><span id="officeFax">+1 415 766 4252</span>
							</li>				
							
							<li class="form-list-item">
								<img class="icon" src="<?php bloginfo('template_directory'); ?>/images/dev/message.png"><span><a href="mailto:info@avenuecode.com" id="mailLink">info@avenuecode.com</a></span>
							</li>				
						</ul>
					</div>
